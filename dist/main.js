...
/***/ "./src/functions/showCountryError.js":
/*!*******************************************!*\
  !*** ./src/functions/showCountryError.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ showCountryError)\n/* harmony export */ });\nfunction showCountryError() {\n  var country = document.querySelector('#country');\n  var countryError = document.querySelector('.country-error');\n\n  if (country.validity.patternMismatch) {\n    countryError.innerHTML = 'Entered value cannot include special charecters.';\n  }\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/functions/showCountryError.js?");

/***/ }),

/***/ "./src/functions/showEmailError.js":
/*!*****************************************!*\
  !*** ./src/functions/showEmailError.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {\n  var email = document.querySelector('#email');\n  var error = document.querySelector('.email-error');\n\n  if (!email.validity.valid) {\n    if (email.validity.valueMissing) error.innerHTML = 'You need to enter an e-mail address.';else if (email.validity.typeMismatch) error.innerHTML = 'Entered value needs to be an e-mail address.';else if (email.validity.tooShort) error.innerHTML = \"Email should be at least \".concat(email.minLength, \" characters; you entered \").concat(email.value.length, \".\");\n  } else error.innerHTML = '';\n});\n\n//# sourceURL=webpack://my-webpack-project/./src/functions/showEmailError.js?");

/***/ }),

/***/ "./src/functions/showPasswordError.js":
/*!********************************************!*\
  !*** ./src/functions/showPasswordError.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ showPasswordError)\n/* harmony export */ });\nfunction showPasswordError() {\n  var password = document.querySelector('#password');\n  var passwordError = document.querySelector('.password-error');\n\n  if (password.validity.patternMismatch) {\n    // If the field doesn't match the pattern,\n    // display the following error message.\n    passwordError.innerHTML = 'Password must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters.';\n  }\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/functions/showPasswordError.js?");

/***/ }),

/***/ "./src/functions/showZipCodeError.js":
/*!*******************************************!*\
  !*** ./src/functions/showZipCodeError.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ showZipCodeError)\n/* harmony export */ });\nfunction showZipCodeError() {\n  var zipCode = document.querySelector('#zip-code');\n  var zipCodeError = document.querySelector('.zip-code-error');\n\n  if (zipCode.validity.patternMismatch) {\n    // If the field doesn't contain a valid country,\n    // display the following error message.\n    zipCodeError.innerHTML = 'Zip code must contain 5 numbers.';\n  }\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/functions/showZipCodeError.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.css */ \"./src/styles/style.css\");\n/* harmony import */ var _functions_showEmailError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/showEmailError */ \"./src/functions/showEmailError.js\");\n/* harmony import */ var _functions_showCountryError__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/showCountryError */ \"./src/functions/showCountryError.js\");\n/* harmony import */ var _functions_showZipCodeError__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/showZipCodeError */ \"./src/functions/showZipCodeError.js\");\n/* harmony import */ var _functions_showPasswordError__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/showPasswordError */ \"./src/functions/showPasswordError.js\");\n\n\n\n\n\nvar form = document.querySelector('.form');\nvar email = document.querySelector('#email');\nemail.addEventListener('input', function () {\n  return (0,_functions_showEmailError__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n});\nvar country = document.querySelector('#country');\nvar countryError = document.querySelector('.country-error');\ncountry.addEventListener('input', function () {\n  if (country.validity.valid || country.validity.valueMissing) {\n    countryError.innerHTML = ''; // resets validity text\n  } else {\n    (0,_functions_showCountryError__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  }\n});\nvar zipCode = document.querySelector('#zip-code');\nvar zipCodeError = document.querySelector('.zip-code-error');\nzipCode.addEventListener('input', function () {\n  if (zipCode.validity.valid) {\n    zipCodeError.innerHTML = ''; // resets validity text\n  } else {\n    (0,_functions_showZipCodeError__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  }\n});\nvar password = document.querySelector('#password');\nvar passwordError = document.querySelector('.password-error');\npassword.addEventListener('input', function () {\n  if (password.validity.valid) {\n    passwordError.innerHTML = ''; // resets validity text\n  } else {\n    (0,_functions_showPasswordError__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  }\n});\nvar confirmPassword = document.querySelector('#confirm-password');\nvar confirmPasswordError = document.querySelector('.confirm-password-error');\nconfirmPassword.addEventListener('input', function () {\n  if (password.value === confirmPassword.value) {\n    confirmPasswordError.innerHTML = ''; // resets validity text\n  } else {\n    confirmPasswordError.innerHTML = 'Does not match password';\n  }\n});\nform.addEventListener('submit', function (event) {\n  if (!email.validity.valid) {\n    // If email isn't valid, display an appropriate error message\n    (0,_functions_showEmailError__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  } else if (!country.validity.valid) {\n    // If country isn't valid, display an appropriate error message\n    (0,_functions_showCountryError__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  } else if (!zipCode.validity.valid) {\n    // If zip code isn't valid, display an appropriate error message\n    (0,_functions_showZipCodeError__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  } else if (!password.validity.valid) {\n    // TODO this part\n    // if password section isn't valid, display an appropriate error message\n    (0,_functions_showPasswordError__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  } else if (!(password.value === confirmPassword.value)) {\n    confirmPasswordError.innerHTML = 'Does not match password';\n  } // Then we prevent the form from being sent by canceling the event\n\n\n  event.preventDefault();\n});\n\n//# sourceURL=webpack://my-webpack-project/./src/index.js?");
